...
function AJAXSearchGrid(container, params, tableHTML) {
	...
	var ajaxSearchGridInstance = this;
		...
		function(row) {
			...
			for (var i = 0; i < ajaxSearchGridInstance.searchableColumns.length; i++) {
				searchByOptions.push({
					searchBy:ajaxSearchGridInstance.searchableColumns[i].pfx+ajaxSearchGridInstance.searchableColumns[i].name,
					description:ajaxSearchGridInstance.searchableColumns[i].title
				});
			}
			ajaxSearchGridInstance.$scope.$apply(function() {
				ajaxSearchGridInstance.$scope.searchByOptions = searchByOptions;
			});
			ajaxSearchGridInstance.$scope.triggerSearch();
		},
		url
	);
