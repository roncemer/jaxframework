...
$GENERATOR_CFG_VALIDATIONS = array(
	...
	new GenCfgValidation('cruds/*/formFields/*/containerCSSClass', 'string'),
	...
	new GenCfgValidation('cruds/*/formFields/*/ajaxCombobox', 'array'),
	new GenCfgValidation('cruds/*/formFields/*/ajaxCombobox/*', 'string,integer,float,double,boolean'),
	new GenCfgValidation('cruds/*/formFields/*/ajaxCombobox/rowFetcherOptionalParameters', 'array'),
	new GenCfgValidation('cruds/*/formFields/*/ajaxCombobox/rowFetcherOptionalParameters/*', 'string,integer,float,double,boolean'),
